...
const Nav = props => __jsx("nav", null, __jsx("ul", null, __jsx("li", null, __jsx("a", {
  href: `${"/next_poc"}/`
}, "Home")), __jsx("li", null, __jsx("a", {
  href: `${"/next_poc"}/projects`
}, "Projects"))));
// EXTERNAL MODULE: ./data/layout.json
var layout = __webpack_require__("Ouoe");
...
const Header = props => Header_jsx("header", null, Header_jsx("h1", null, Header_jsx("img", {
  src: `${"/next_poc"}/static/logo.svg`,
  alt: "POC Logo"
}), layout.title), Header_jsx("p", null, layout.tagline), Header_jsx(Nav, null));
// CONCATENATED MODULE: ./components/Footer/index.js

var Footer_jsx = external_react_default.a.createElement;

const Footer = props => Footer_jsx("footer", null, Footer_jsx("h2", null, layout.footer), Footer_jsx("p", null, "\xA9", layout.copyright));
...
class _document_MyDocument extends document_default.a {
  ...
  render() {
    return _document_jsx(next_document["Html"], {
      lang: "en"
    }, _document_jsx(next_document["Head"], null), _document_jsx("body", null, _document_jsx(Header, null), _document_jsx(next_document["Main"], null), _document_jsx(next_document["NextScript"], null), _document_jsx(Footer, null)));
  }
...
module.exports = JSON.parse("{\"title\":\"Global Title\",\"tagline\":\"Sic transit gloria mundi.\",\"footer\":\"Footer Content\",\"copyright\":\"2020\"}");
