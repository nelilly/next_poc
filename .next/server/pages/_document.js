...
const Header = props => Header_jsx("header", null, Header_jsx("h1", null, Header_jsx("img", {
  ...
  alt: "POC Logo"
}), data[0].title), Header_jsx("p", null, data[0].description), Header_jsx(components_Nav, null));
...
const Footer = props => Footer_jsx("footer", null, Footer_jsx("h2", null, data[0].footer), Footer_jsx("p", null, "\xA92020"));
...
class _document_MyDocument extends document_default.a {
  ...
  render() {
    return _document_jsx(next_document["Html"], {
      lang: "en"
    }, _document_jsx(next_document["Head"], null), _document_jsx("body", null, _document_jsx(components_Header, null), _document_jsx(next_document["Main"], null), _document_jsx(next_document["NextScript"], null), _document_jsx(components_Footer, null)));
  }
...
module.exports = JSON.parse("[{\"id\":0,\"title\":\"Global Title\",\"description\":\"Sic transit gloria mundi.\",\"footer\":\"Footer Content\"}]");
